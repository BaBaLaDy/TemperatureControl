...
//  Uart1_Rx++; 
//        
//  if(Uart1_Buffer[Uart1_Rx-1] == 0x0a || Uart1_Rx == Max_BUFF_Len)    //如果接收到尾标识是换行符（或者等于最大接受数就清空重新接收）
//  {
//   if(Uart1_Buffer[0] == '0x5a')                      //检测到头标识是我们需要的 
//   {
//    printf("%s",Uart1_Buffer);        //这里我做打印数据处理
//		//  printf("检测到包头");
//    Uart1_Rx=0;                                   
//   } 
//   else
